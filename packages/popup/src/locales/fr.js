const fr = {
  translation: {
    ...
    viewSelectedAddress: 'Afficher l’adresse publique du compte sélectionné',
    viewMultiAddress: 'Afficher l’adresse multi-chaîne du compte sélectionné',
    ...
    editGasFee: 'Éditer les frais de Gas',
    low: 'Faible',
    medium: 'Marché',
    high: 'Aggressif',
    suggested: 'Suggéré',
    ...
    maxPriorityFeePerGas: 'Frais Prioritaire Max Par Gas',
    maxFee: 'Frais Max',
    baseFee: 'Frais de Base',
    priorityFee: 'Frais Prioritaire',
    current: 'Actuel: ',
    twelveHour: '12h: ',
    ...
    maxPriorityFeePerGasLowErr:
      'La valeur minimale tapée est {{amount}} {{unit}}',
    ...
    disablePersonSign:
      'Le signe personnel n’est pas encore supporté sur wallet matériel.',
    disableTypeSign: 'Le signe tapé n’est pas encore supporté sur wallet matériel.',
    ...
    lastAccountHideWarning: 'Garder au minimum un compte dans ce groupe.',
    ...
    hardwareAccountTips: 'Le compte(s) ajouté(s) est disponible sur {{chain}}',
    ready: 'Prêt',
    ...
    wrongAddressType: 'Type d’adresse erroné',
    notEnoughBaseGas: 'Pas assez de Gas',
    ...
    hwOpenApp:
      'Assurez-vous que l’App {{appName}} soit ouverte avant de cliquer sur "Confirmer".',
    ...
    recent: 'Récent',
    account: 'Compte',
    searchAddressNickname: 'Rechercher une adresse ou un pseudo',
    addedContactWarning: 'Cette adresse a déjà été ajoutée!',
    deleteContactTitle: 'Confirmer pour supprimer ce contact',
